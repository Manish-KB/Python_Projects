...
okbtn=driver.find_element("xpath",'/html/body/app-root/app-home/div[1]/app-header/p-dialog[2]/div/div/div[2]/div/form/div[2]/button')
okbtn.click()
loginbtn=driver.find_element("xpath",'/html/body/app-root/app-home/div[1]/app-header/div[2]/div[2]/div[1]/a[1]')
loginbtn.click()
logininput=driver.find_element("xpath",'/html/body/app-root/app-home/div[3]/app-login/p-dialog[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/form/div[1]/input')
logininput.send_keys('sumithtrip')
passwordinput=driver.find_element("xpath",'/html/body/app-root/app-home/div[3]/app-login/p-dialog[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/form/div[2]/input')
...
captcha=driver.find_element("xpath",'/html/body/app-root/app-home/div[3]/app-login/p-dialog[1]/div/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/form/div[4]/div/app-nlp-captcha/div/div[2]/div/div[3]/div[1]/input')
